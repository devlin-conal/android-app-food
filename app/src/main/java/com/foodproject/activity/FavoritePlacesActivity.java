...
public class FavoritePlacesActivity extends AppCompatActivity implements RestaurantAdapter.OnRestaurantClickListener{
...
//        GridLayoutManager llmProduct = new GridLayoutManager(this, 2);
        ...
        RestaurantAdapter mRestaurantAdapter = new RestaurantAdapter(this);
        mRecyclerView.setAdapter(mRestaurantAdapter);
    }

    @Override
    public void onRestaurantClickListener(RestaurantResponse place) {
        startActivity(new Intent(FavoritePlacesActivity.this, RestaurantActivity.class));
    }
